 ...
 */
public class DownloadListarObraPonto extends AsyncTask<Integer, String, ArrayList<Obra>> {
    private Context context;
    private ProgressDialog progressDialog;
    public static ConfigSistema cfgs = new ConfigSistema();

    public DownloadListarObraPonto(Context contexto){
...
//        progressDialog.show();
    ...
    protected ArrayList<Obra> doInBackground(Integer... params) {
        ...
        try {
            ...
            //envia objeto
            oos.writeObject(new Solicitacao(Solicitacao.iObraPontoListar, "", "", "", idPonto));
            ...
            //imprime log
            if (obras != null) {
                Log.i("ListaObraPontoActivity", "RETORNO:> " + obras.size());
            } else {
                Log.i("ListaObraPontoActivity", "RETORNO:> Não há obras cadastradas!");
            }
