 ...
 */
public class ListaDeletar extends AsyncTask<Integer, String, Lista> {
    private Context context;
    private ProgressDialog progressDialog;
    public static ConfigSistema cfgs = new ConfigSistema();

    public ListaDeletar(Context contexto){
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setMessage("Removendo Ponto Turístico da lista...");
        progressDialog.show();
        super.onPreExecute();
    }
    ...
    protected Lista doInBackground(Integer... params) {
        ...
        try {
            ...
            //envia objeto
            oos.writeObject(new Solicitacao(Solicitacao.iListaRemover, "", "", "", lista));
            ...
            if (lista != null) {
                ...
                Log.i("ListaAdicionarActivity", "RETORNO:> Não foi possível remover a lista!");
            }
