 ...
 */
public class DownloadListarFotoArtista extends AsyncTask<Integer, String, ArrayList<Foto>> {
    private Context context;
    private ProgressDialog progressDialog;
    public static ConfigSistema cfgs = new ConfigSistema();

    public DownloadListarFotoArtista(Context contexto){
...
//        progressDialog.show();
    ...
    protected ArrayList<Foto> doInBackground(Integer... params) {
        ...
        try {
            ...
            //envia objeto
            oos.writeObject(new Solicitacao(Solicitacao.iFotoListar, "", "", "artista", idReferencia));
            ...
            //imprime log
            if (fotos != null) {
                Log.i("DownloadListaFotoArtist", "RETORNO:> " + fotos.size());
            } else {
                Log.i("DownloadListaFotoArtist", "RETORNO:> Não há fotos cadastradas!");
            }
