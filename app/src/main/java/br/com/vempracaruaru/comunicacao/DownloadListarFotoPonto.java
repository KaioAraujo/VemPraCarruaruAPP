 ...
 */
public class DownloadListarFotoPonto extends AsyncTask<Integer, String, ArrayList<Foto>> {
    private Context context;
    private ProgressDialog progressDialog;
    public static ConfigSistema cfgs = new ConfigSistema();

    public DownloadListarFotoPonto(Context contexto){
...
//        progressDialog.show();
    ...
    protected ArrayList<Foto> doInBackground(Integer... params) {
        ...
        try {
            ...
            //envia objeto
            oos.writeObject(new Solicitacao(Solicitacao.iFotoListar, "", "", "ponto", idReferencia));
            ...
            //imprime log
            if (fotos != null) {
                Log.i("DownloadListaFotoPonto", "RETORNO:> " + fotos.size());
            } else {
                Log.i("DownloadListaFotoPonto", "RETORNO:> Não há fotos cadastradas!");
            }
