 ...
 */
public class DownloadListarListaVisitado extends AsyncTask<Integer, String, ArrayList<Lista>> {
    private Context context;
    private ProgressDialog progressDialog;
    public static ConfigSistema cfgs = new ConfigSistema();

    public DownloadListarListaVisitado(Context contexto){
...
//        progressDialog.show();
    ...
    protected ArrayList<Lista> doInBackground(Integer... params) {
        ...
        try {
            ...
            //envia objeto
            oos.writeObject(new Solicitacao(Solicitacao.iPontoVisitadoListar, "", "", "", idUsuario));
